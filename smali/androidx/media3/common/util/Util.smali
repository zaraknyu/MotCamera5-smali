...
.method public static binarySearchFloor(Landroidx/media3/common/util/LongArray;J)I
    .locals 6
    ...
    .line 3
    iget v3, p0, Landroidx/media3/common/util/LongArray;->size:I
...
.method public static getMediaDurationForPlayoutDuration(FJ)J
    .locals 2
...
.method public static handlePlayButtonAction(Landroidx/media3/common/Player;)Z
    ...
    invoke-virtual {v5, v4}, Landroidx/media3/common/BasePlayer;->isCommandAvailable(I)Z
    ...
    invoke-virtual {v2, v4, v5, v1, v0}, Landroidx/media3/common/BasePlayer;->seekTo(JIZ)V
    ...
    invoke-virtual {p0, v3}, Landroidx/media3/common/BasePlayer;->isCommandAvailable(I)Z
...
.method public static inferContentTypeForUriAndMimeType(Landroid/net/Uri;Ljava/lang/String;)I
    ...
    invoke-static {v6, p1}, Lcom/google/common/base/Ascii;->equalsIgnoreCase(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_e

    const-string/jumbo v6, "rtspt"
    ...
    sget-object p1, Landroidx/media3/common/util/Util;->ISM_PATH_PATTERN:Ljava/util/regex/Pattern;
...
.method public static isFrameDropAllowedOnSurfaceInput(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v1}, Lcom/google/common/base/Ascii;->equalsIgnoreCase(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0}, Lcom/google/common/base/Ascii;->equalsIgnoreCase(Ljava/lang/String;Ljava/lang/String;)Z
