...
.method static constructor <clinit>()V
    ...
    const-string v2, "ANC_HUM_IMG_BGR"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;-><init>(Ljava/lang/String;I)V
    ...
    new-instance v2, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    const-string v3, "ANC_HUM_IMG_RGB"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;->ANC_HUM_IMG_RGB:Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    new-instance v3, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    const-string v4, "ANC_HUM_IMG_RGBA"

    const/4 v5, 0x3

    invoke-direct {v3, v4, v5}, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;->ANC_HUM_IMG_RGBA:Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    new-instance v4, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    const-string v5, "ANC_HUM_IMG_DEPTH"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;->ANC_HUM_IMG_DEPTH:Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    new-instance v5, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    const-string v6, "ANC_HUM_IMG_GREYSCALE"

    const/4 v7, 0x5

    invoke-direct {v5, v6, v7}, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;->ANC_HUM_IMG_GREYSCALE:Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    new-instance v6, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    const-string v7, "ANC_HUM_IMG_NV12"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;->ANC_HUM_IMG_NV12:Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    filled-new-array/range {v0 .. v6}, [Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;

    move-result-object v0

    sput-object v0, Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;->$VALUES:[Lcom/anc/humansdk/fusion/HumanEffectFusionApi$ImageType;
